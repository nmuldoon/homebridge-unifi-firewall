...
async function discoverPolicies(): Promise<void> {
  ...
  try {
    ...
    // Try to discover UniFi 9 policies using the correct API endpoints
    const endpoints = [
      // Working firewall policies endpoints (from browser inspection)
      {
        url: `/proxy/network/v2/api/site/${config.site}/firewall-policies`,
        options: {},
      },
      {
      ...
      {
        url: `/proxy/network/v2/api/site/${config.site}/firewall-policies/defaults`,
        options: {},
      },
      {
        url: `/proxy/network/v2/api/site/default/firewall-policies/defaults`,
        options: {},
      },
